...
**Smart Waste MIS** نظام متكامل لإدارة البنية التحتية لشفط النفايات مبني بتقنيات حديثة. يوفر النظام بيانات فورية (Realtime) لمستويات الامتلاء والضغط وحالة الحاويات، مع دعم ثلاثة مستويات وصول مختلفة: الموظفون، الإدارة العليا، والمواطنون.
